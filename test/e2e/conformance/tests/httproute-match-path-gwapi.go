...
func init() {
	Register(HTTPRouteMatchPathGateway)
}

var HTTPRouteMatchPathGateway = suite.ConformanceTest{
	ShortName:   "HTTPRouteMatchPathGateway",
	...
	Test: func(t *testing.T, suite *suite.ConformanceTestSuite) {
		ToGatewayResource(t, suite, "tests/httproute-match-path.yaml")
