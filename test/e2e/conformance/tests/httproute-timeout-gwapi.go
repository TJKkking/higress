...
func init() {
	Register(HttpTimeoutGateway)
}

var HttpTimeoutGateway = suite.ConformanceTest{
	ShortName:   "HttpTimeoutGateway",
	...
	Test: func(t *testing.T, suite *suite.ConformanceTestSuite) {
		ToGatewayResource(t, suite, "tests/httproute-timeout.yaml")
