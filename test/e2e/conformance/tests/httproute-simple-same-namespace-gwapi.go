...
func init() {
	Register(HTTPRouteSimpleSameNamespaceGateway)
}

var HTTPRouteSimpleSameNamespaceGateway = suite.ConformanceTest{
	ShortName:   "HTTPRouteSimpleSameNamespaceGateway",
	...
	Test: func(t *testing.T, suite *suite.ConformanceTestSuite) {
		ToGatewayResource(t, suite, "tests/httproute-simple-same-namespace.yaml")
