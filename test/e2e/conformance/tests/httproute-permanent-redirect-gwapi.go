...
func init() {
	Register(HTTPRoutePermanentRedirectGateway)
}

var HTTPRoutePermanentRedirectGateway = suite.ConformanceTest{
	ShortName:   "HTTPRoutePermanentRedirectGateway",
	...
	Test: func(t *testing.T, suite *suite.ConformanceTestSuite) {
		ToGatewayResource(t, suite, "tests/httproute-permanent-redirect.yaml")
