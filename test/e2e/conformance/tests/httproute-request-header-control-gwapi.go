...
func init() {
	Register(HTTPRouteRequestHeaderControlGateway)
}

var HTTPRouteRequestHeaderControlGateway = suite.ConformanceTest{
	ShortName:   "HTTPRouteRequestHeaderControlGateway",
	...
	Test: func(t *testing.T, suite *suite.ConformanceTestSuite) {
		ToGatewayResource(t, suite, "tests/httproute-request-header-control.yaml")
